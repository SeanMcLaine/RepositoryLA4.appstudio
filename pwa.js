...
const cacheName = 'RepositoryLA4-2021-09-15 16:02:21.470446'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'RepositoryLA4'.length) === 'RepositoryLA4') {
